...
from onescience.datapipes.genscore.feats.mol2graph_rdmda_res import (
    load_mol,
    mol_to_graph,
    prot_to_graph,
)
from onescience.datapipes.genscore.feats.extract_pocket_prody import (
    extract_pocket,
)
	...
	def __init__(self,  
		...
		if isinstance(ligs,np.ndarray) or isinstance(ligs,list):
			...
			if ligs.endswith(".mol2"):
				...
				raise ValueError(
					"Only .sdf/.mol2 ligand files or prebuilt torch_geometric.data.Data "
