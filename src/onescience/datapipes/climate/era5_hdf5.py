...
class ERA5HDF5Datapipe(Datapipe):
    ...
    def train_dataloader(self):
        data = ERA5Dataset(
            params=self.params,
            data_paths=self.params.train_data_dir,
    ...
    def val_dataloader(self):
        data = ERA5Dataset(
            params=self.params,
            data_paths=self.params.val_data_dir,
            num_steps=self.num_steps,
            input_steps=self.input_steps,
        )
        sampler = DistributedSampler(
    ...
    def test_dataloader(self):
        data = ERA5Dataset(
            params=self.params,
            data_paths=self.params.test_data_dir,
            num_steps=self.num_steps,
            input_steps=self.input_steps,
        )
        data_loader = DataLoader(
...
class ERA5Dataset(Dataset):
    def __init__(
        self, params, data_paths, num_steps=1, input_steps=1, patch_size=[1, 1]
    ):
        self.params = params
