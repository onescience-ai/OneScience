...
from onescience.models.laproteina.datasets.gen_dataset import GenDataset
from onescience.models.laproteina.proteina import Proteina
...
CONFIG_ROOT = Path(__file__).resolve().parents[2] / "configs" / "bio" / "laproteina"
