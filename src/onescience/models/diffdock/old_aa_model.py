...
from onescience.models.diffdock.layers import GaussianSmearing, OldAtomEncoder, AtomEncoder
from onescience.models.diffdock.tensor_layers import OldTensorProductConvLayer
