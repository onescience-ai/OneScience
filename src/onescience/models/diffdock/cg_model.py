...
from onescience.models.diffdock.layers import AtomEncoder, GaussianSmearing
from onescience.models.diffdock.tensor_layers import TensorProductConvLayer, get_irrep_seq
