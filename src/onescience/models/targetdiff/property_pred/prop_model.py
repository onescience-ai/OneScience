...
from onescience.models.targetdiff.property_pred.prop_egnn import EnEquiEncoder
from onescience.models.targetdiff.common import compose_context_prop, ShiftedSoftplus
