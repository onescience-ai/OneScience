...
from onescience.models.figconvunet.base_model import BaseModel
from onescience.models.figconvunet.components.encodings import SinusoidalEncoding
from onescience.models.figconvunet.components.mlp import MLP
from onescience.models.figconvunet.components.reductions import REDUCTION_TYPES
from onescience.models.figconvunet.geometries import (
    GridFeaturesMemoryFormat,
    PointFeatures,
)
from onescience.models.figconvunet.grid_feature_group import (
...
from onescience.models.figconvunet.point_feature_conv import (
    PointFeatureTransform,
)
from onescience.models.figconvunet.point_feature_grid_conv import (
    GridFeatureMemoryFormatConverter,
)
from onescience.models.figconvunet.point_feature_grid_ops import PointFeatureToGrid
...
class FIGConvUNet(BaseModel):
    ...
    def __init__(
        ...
        neighbor_search_type: Literal["knn"] = "knn",
        knn_k: int = 16,
