...
def pde_CFD2d(x, y, gamma):
    ...
    eq1 = h_t + hu_x + hu_y
    eq2 = (
        h * (ux_t + ux * ux_x + uy * ux_y)
        + p_x
        - eta * (ux_xx + ux_yy)
        - (zeta + eta / 3.0) * (ux_xx + ux_yy)
    )
    eq3 = (
        h * (uy_t + ux * uy_x + uy * uy_y)
        + p_y
        - eta * (uy_xx + uy_yy)
        - (zeta + eta / 3.0) * (uy_xx + uy_yy)
    )
    eq4 = E_t + Fx_x + Fy_y
...
def pde_CFD3d(x, y, gamma):
    ...
    eq2 = (
        h * (ux_t + ux * ux_x + uy * ux_y + uz * ux_z)
        + p_x
        - eta * (ux_xx + ux_yy + ux_zz)
        - (zeta + eta / 3.0) * (ux_xx + ux_yy + ux_zz)
    )
    eq3 = (
        h * (uy_t + ux * uy_x + uy * uy_y + uz * uy_z)
        + p_y
        - eta * (uy_xx + uy_yy + uy_zz)
        - (zeta + eta / 3.0) * (uy_xx + uy_yy + uy_zz)
    )
    eq4 = (
        h * (uz_t + ux * uz_x + uy * uz_y + uz * uz_z)
        + p_z
        - eta * (uz_xx + uz_yy + uz_zz)
        - (zeta + eta / 3.0) * (uz_xx + uz_yy + uz_zz)
    )
