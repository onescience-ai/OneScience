...
_LEGACY_IMPORT_PREFIX_V4 = [('onescience.models.UMA.base', 'onescience.models.UMA.base'), ('onescience.models.UMA.uma_escn_moe', 'onescience.models.UMA.uma_escn_moe'), ('onescience.models.UMA.uma_escn_moe', 'onescience.models.UMA.uma_escn_moe'), ('onescience.models.UMA.uma_escn_moe', 'onescience.models.UMA.uma_escn_moe'), ('onescience.models.UMA.base', 'onescience.models.UMA.base'), ('onescience.models.UMA.uma_escn_moe', 'onescience.models.UMA.uma_escn_moe'), ('onescience.models.UMA.units', 'onescience.utils.uma.units'), ('onescience.models.UMA.modules', 'onescience.utils.uma.modules'), ('onescience.models.UMA.common', 'onescience.utils.uma.common'), ('fairchem.core.units', 'onescience.utils.uma.units'), ('fairchem.core.modules', 'onescience.utils.uma.modules'), ('fairchem.core.components', 'onescience.utils.uma.components'), ('fairchem.core.common', 'onescience.utils.uma.common'), ('fairchem.core', 'onescience.utils.uma')]

def _rewrite_legacy_dotpath_v4(path: str) -> str:
    prev = None
    cur = path
    while cur != prev:
        prev = cur
        for old, new in _LEGACY_IMPORT_PREFIX_V4:
...
_LEGACY_IMPORT_PREFIX = (
    ("onescience.models.UMA.uma", "onescience.utils.uma.models.uma"),
...
def _rewrite_legacy_dotpath(path: str) -> str:
    for old, new in _LEGACY_IMPORT_PREFIX:
...
def _get_absolute_mapping(name: str):
    name = _rewrite_legacy_dotpath_v4(name)
    name = _rewrite_legacy_dotpath(name)
...
class Registry:
    ...
    def register_logger(cls, name: str):
        ...
        def wrap(func: Callable[..., R]) -> Callable[..., R]:
            from onescience.monitoring.uma.logger import Logger
