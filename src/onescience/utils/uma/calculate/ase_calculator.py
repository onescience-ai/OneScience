...
from onescience.utils.uma.calculate import pretrained_mlip
...
class FAIRChemCalculator(Calculator):
    ...
    def from_model_checkpoint(
        ...
        Args:
            ...
            name_or_path: A model name from onescience.utils.uma.pretrained.available_models or a path to the checkpoint
                file
            task_name: Task name
    ...
    def _get_single_atom_energies(self, atoms) -> dict:
        ...
        if self.predictor.atom_refs is None:
            raise ValueError(
                ...
                "Please call onescience.utils.uma.pretrained_mlip.get_predict_unit() "
