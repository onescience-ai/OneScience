...
from onescience.utils.uma.scripts.migrate_imports import mapping
from onescience.utils.uma.units.mlip_unit import MLIPPredictUnit
...
def migrate_checkpoint(
    ...
    defined in onescience.utils.uma.scripts.migrate_imports,
    ...
    backbone_model = checkpoint.model_config["backbone"]["model"]
    if backbone_model in {
        "fairchem.experimental.foundation_models.models.message_passing.escn_omol.eSCNMDBackbone",
        "onescience.models.UMA.uma_escn_md.eSCNMDBackbone",
    }:
        checkpoint.model_config["backbone"]["use_dataset_embedding"] = False

    if backbone_model == "onescience.models.UMA.uma_escn_moe.eSCNMDMoeBackbone":
