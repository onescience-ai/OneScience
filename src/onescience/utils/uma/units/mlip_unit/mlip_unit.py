...
from onescience.utils.uma.common.distutils import (
...
from onescience.utils.uma.components.train.train_runner import Checkpointable
...
from onescience.utils.uma.normalization.element_references import (  # noqa: TCH001
    ElementReferences,
)
from onescience.utils.uma.normalization.normalizer import Normalizer  # noqa: TCH001
from onescience.utils.uma.scheduler import CosineLRLambda
from onescience.metrics.uma.mlip_metrics import Metrics, get_metrics_fn
from onescience.utils.uma.units.mlip_unit.api.inference import (
    MLIPInferenceCheckpoint,
)
from onescience.utils.uma.units.mlip_unit.utils import load_inference_model
...
class MLIPTrainEvalUnit(
    ...
    def __init__(
        ...
        if train_strategy == TrainStrategy.DDP:
            ...
            from onescience.models.UMA.uma_escn_moe import MOELinear
    ...
    def on_train_start(self, state: State) -> None:
        ...
        if self.profile_flops:
            ...
            from onescience.utils.uma.components.common.flops_profile import get_flops_profile
