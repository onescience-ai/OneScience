...
#from onescience.utils.mace import data
# ✨ 关键：导入 L3-Core 模块
...
from onescience.modules.func_utils.mace_func_utils import extract_invariant

#from onescience.utils.mace.tools import torch_geometric, torch_tools, utils
from onescience.datapipes.materials.tools import torch_geometric, torch_tools, utils

from onescience.utils.mace.tools.compile import prepare
from onescience.utils.mace.tools.scripts_utils import extract_model
