...
import torch
from onescience.models.mace.mace import AtomicDipolesMACE, EnergyDipolesMACE, ScaleShiftMACE
...
from onescience.utils.mace.tools.finetuning_utils import load_foundations_elements
from onescience.utils.mace.tools.scripts_utils import extract_config_mace_model
...
def configure_model(
    ...
    if (
        ...
        args.mean, args.std = SCALING_CLASSES[args.scaling](
