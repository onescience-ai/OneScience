...
def pretrain(
    ...
    #print("===print train data loader:"+str(train_data_iterator)+"===")
    ...
    if not args.skip_train:
        ...
        if args.save and iteration != 0 and iteration % args.save_interval != 0:
            #from onescience.distributed.megatron.core.dist_checkpointing.dsp import save_checkpoint_torch,load_checkpoint_torch

            #rank = torch.distributed.get_rank()
            #checkpoint_dir = f"./save_checkpoint/iter_{iteration}"

            #save_checkpoint_torch(rank,model,None,checkpoint_dir)
            print("save_this route...")
            save_checkpoint(
                iteration,
                model,
                optimizer,
...
def setup_model_and_optimizer(
    ...
    if (
        ...
        #print("model:",model)
        #exit()
        load_checkpoint_torch(rank,model[0],None,checkpoint_dir)
...
def checkpoint_and_decide_exit(
    ...
    if args.save and args.save_interval and iteration % args.save_interval == 0:
        ...
        #    train_data_iterator=train_data_iterator,
        #)
        from onescience.distributed.megatron.core.dist_checkpointing.dsp import save_checkpoint_torch
        ...
        #print("model:",model)
        #exit()
        save_checkpoint_torch(rank,model[0],None,checkpoint_dir)
        print_rank_last("save_done...")
