...
def find_structural_violations(
    ...
    connection_violations = between_residue_bond_loss(
        ...
        aatype=aatype,
        tolerance_factor_soft=config["structural_violation"][
            "violation_tolerance_factor"
        ],
        tolerance_factor_hard=config["structural_violation"][
            "violation_tolerance_factor"
        ],
    )
    ...
    between_residue_clashes = between_residue_clash_loss(
        ...
        overlap_tolerance_soft=config["structural_violation"][
            "clash_overlap_tolerance"
        ],
        overlap_tolerance_hard=config["structural_violation"][
            "clash_overlap_tolerance"
        ],
        asym_id=asym_id,
    )
    ...
    restype_atom14_bounds = residue_constants.make_atom14_dists_bounds(
        ...
        bond_length_tolerance_factor=config["structural_violation"][
            "violation_tolerance_factor"
        ],
    )
