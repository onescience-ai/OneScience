...
from onescience.flax_models.alphagenome._sdk.models import dna_client
...
def load(organism: dna_model.Organism) -> AlphaGenomeOutputMetadata:
  ...
  content = resources.files('onescience.flax_models.alphagenome').joinpath(path).read_text()
