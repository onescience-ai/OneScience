...
class Custom_op(BaseTool):
    ...
    def call(self, params:str, **kwargs) -> float:
        ...
        return json5.dumps(
            {'op_result': a**2 - b**2}, ensure_ascii=False)
...
class Custom_op_2(BaseTool):
    ...
    def call(self, params:str, **kwargs) -> float:
        ...
        return json5.dumps(
            {'op_result': a**3 + b**3 + c**3}, ensure_ascii=False)
...
tools = ['Custom_op', 'Custom_op_2','code_interpreter']  # `code_interpreter` is a built-in tool for executing code.
