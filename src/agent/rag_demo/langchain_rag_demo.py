...
tokenizer = AutoTokenizer.from_pretrained(model_path, truncation=True, trust_remote_code=True)
...
def retrieve(state: State):
    retrieved_docs = vector_store.similarity_search(state["question"]+state["question"])
