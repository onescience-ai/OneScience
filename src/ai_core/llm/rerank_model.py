...
# model_dir = snapshot_download('Qwen/Qwen3-Reranker-0.6B',cache_dir="../download")
...
if __name__ == "__main__":
    # reranker = Qwen3Reranker("../download/Qwen/Qwen3-Reranker-0.6B")
    # query = "What is the capital of China?"
    #
    # documents = [
    #     Document(page_content="The capital of China is Beijing."),
    #     Document(page_content="The capital of China is Chengdu."),
    # ]
