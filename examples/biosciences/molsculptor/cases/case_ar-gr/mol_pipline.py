...
def inference_pipeline():
    ...
    def inference_step(step_it, x, cached, rng_key, config):
        ...
        decode_molecules = decoder_dict["decode_molecules"] # decode_molecules : dict_keys(['graphs', 'smiles'])
        cached_smiles = decoder_dict["cached_smiles"] # [[CCOC(=O)c1ccc(NC(=O)c2cccc(S(=O)(=O)N3CCCc4ccccc43)c2)s1 * 128]]
        ...
        choiced_dict = selecet_f(scores, constraints, decode_molecules, cached, search_config, cached_smiles)
