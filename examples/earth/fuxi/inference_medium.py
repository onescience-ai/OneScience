...
def inference(data_loader, year_list, step, model):
    save_path = os.path.join("./data/long/data")
...
if __name__ == "__main__":
    ...
    # cfg.batch_size = 1
    num_steps = cfg.medium_num_steps
    cfg.data_dir = './data/medium'
    ...
    with open(f'./data/medium/metadata.json', "r") as f:
        metadata = json.load(f)
    with open("./data/long/metadata.json", "w") as f:
