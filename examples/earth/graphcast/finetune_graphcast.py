...
def main():
    ...
    ckpt = torch.load(
        f"{cfg.checkpoint_dir}/graphcast.pth", map_location="cpu")
    graphcast_model.load_state_dict(
...
def save_checkpoint(
    ...
    torch.save(
        state, f"{model_path}/graphcast_finetune.pth")
