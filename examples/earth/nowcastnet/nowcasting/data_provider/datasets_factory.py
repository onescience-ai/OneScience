...
def data_provider(configs):
    ...
    if configs.dataset_name == "radar":
        ...
        test_input_handle = datasets_map[configs.dataset_name].InputHandle(
            test_input_param
        )
...
def train_data_provider(configs):
    if configs.dataset_name == "radar":
        ...
        train_input_handle = datasets_map[configs.dataset_name].InputHandle(
            train_input_param
        )
        ...
        train_dataset, val_dataset = random_split(
            train_input_handle, [train_size, val_size]
        )
