...
def train_wrapper_pytorch_loader(EvoNet, GenNet, DisNet):
    ...
    args.batch_size = batch_size_test
    evaluator.train_pytorch_loader(EvoNet, GenNet, DisNet, train_input_handle, val_input_handle, args)

print('Initializing models')
print(f"do_train: {args.do_train}", f"gen_pre: {args.gen_pre}", f"gen_lr: {args.gen_lr}", f"dis_lr: {args.dis_lr}", 'else: ')
