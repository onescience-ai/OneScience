...
conda init bash # 该命令视具体环境下激活conda的方法进行修改
...
torchrun --nproc_per_node=8 --nnodes=1 --rdzv_id=1000 --rdzv_backend=c10d --max_restarts=0 --master_addr="localhost" --master_port=29500 train_fengwu.py
