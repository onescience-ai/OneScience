...
def main():
    ...
    # Model init
    model = Xihe(cfg).to(local_rank)
    mask_full_np = np.load(cfg.mask_dir)  # (2041, 4320)
    ...
    ## Train process init不用改 初始化loss文件
