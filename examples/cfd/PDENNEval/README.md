...
这是一个求解PDE的模型集，包括8个微分方程的神经网络模型。模型参照[PDENNEval](https://www.ijcai.org/proceedings/2024/573) 中的开源模型代码进行构建。
...
我们评估中使用的数据来自两个来源： [PDEBench](https://darus.uni-stuttgart.de/dataset.xhtml?persistentId=doi:10.18419/darus-2986) 和自生成的数据。

曙光新一代机器平台数据集统一存放在：/public/onestore/onedatasets/PDENNEval，使用前需要
...
商品地址：[商品详情](https://www.scnet.cn/ui/mall/detail/goods?type=software&shopId=1846026866430099458&common1=MODEL&id=1871162040368062465&resource=MODEL)

**许可证** 

PDENNEval 项目（包括代码和模型参数）在[Apache 2.0](https://github.com/Sysuzqs/PDENNEval/blob/main/LICENSE)许可下提供，可免费用于学术研究和商业用途