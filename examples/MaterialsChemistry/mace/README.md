...
部分数据集可以从/public/onestore/onedatasets/MaterialsChemistry/下载。
...
​     MACE_models :最终模型 & 评估结果（成品模型、编译版、评估 extxyz）。也可存放预训练模型可以从[ACEsuit/mace: MACE - Fast and accurate machine learning interatomic potentials with higher order equivariant message passing.](https://github.com/ACEsuit/mace) 下载。
