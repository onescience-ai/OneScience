...
FeatureUngroupingAttention = OneAttention(
    style="FeatureUngroupingAttention",
    dim=192,
)
...
out = FeatureUngroupingAttention(obj)
print('Function: FeatureUngroupingAttention Forward')
