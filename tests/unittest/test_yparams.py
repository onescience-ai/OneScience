...
class TestYParams(unittest.TestCase):
    ...
    def test_update_params(self):
        new_config = {
            "param1": "updated_value", "param3": "value3"}
        self.yparams.update_params(new_config)
        self.assertEqual(
            self.yparams["param1"], "updated_value")
    ...
    def test_parse_env_vars(self):
        ...
        self.assertEqual(
            parsed_data["nested"]["param4"], "env_value")
    ...
    def test_parse_env_vars_with_list(self):
        ...
        parsed_data = self.yparams.parse_env_vars(data)
        self.assertEqual(
            parsed_data["param2"][0], "env_value")
        self.assertEqual(
            parsed_data["nested"]["param4"][0], "env_value")
        del os.environ["TEST_ENV_VAR"]
    ...
    def test_parse_env_vars_no_env_var(self):
        ...
        parsed_data = self.yparams.parse_env_vars(data)
        self.assertEqual(
            parsed_data["param2"], "static_value")
